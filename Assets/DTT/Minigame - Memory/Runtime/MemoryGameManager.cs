...
namespace DTT.MinigameMemory
{
    ...
    public class MemoryGameManager : MonoBehaviour, IMinigame<MemoryGameSettings, MemoryGameResults>
    {
        ...
        public void StartGame(MemoryGameSettings settings)
        {
            ...
            LevelSelected?.Invoke(_database.Data[0]);
            Started?.Invoke();
        }
        ...
        public void ForceFinish()
        {
            ...
            var myValue = varManager.GetVariableValue("globalGameResult");
            //myValue += true;
            varManager.SetVariableValue("globalGameResult", "true");

            ReturnToStory("minigameScene");
            //Naninovel.CustomVariable("globalGameResult", "true");
        }
        ...
        public void ReturnToStory(string miniGameSceneName) {
            LoadMiniGameScene(transitionSceneName);
            // Add logic here to transition back to the Naninovel story
        }
